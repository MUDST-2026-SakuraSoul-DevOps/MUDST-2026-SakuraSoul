...
กฎทั้งหมดของการส่ง (ใครได้ ใครถูกข้าม 503 เมื่อไหร่) อยู่ในหัวข้อ "การส่งใบเสร็จทางอีเมล"
...
4. **ใบเสร็จกับเอกสารสัญญาเช่า** ฝั่ง backend เสร็จแล้ว (SSK-16 / SSK-17) มีตาราง `receipt` (V9)
   ...
   - **ตั้งเวลาออกบิล (SSK-130)** ปุ่ม Schedule Auto-Billing ยังเป็นแบบจำลองในหน้าเว็บ ค่าเก็บในเบราว์เซอร์
     และมีป้าย simulation บอกไว้ (SSK-141) PR ถัดไปของ SSK-143 จะย้ายค่าไปเก็บฝั่ง backend
     และให้งานตามเวลาไทยส่งเตือนใบค้างเดือนละครั้ง ส่วนการออกบิลใหม่อัตโนมัติยังทำไม่ได้
     เพราะใบเสร็จต้องมีหน่วยน้ำไฟและยังไม่มีตารางค่ามิเตอร์
