              ...
              return (
                <div className="mt-4">
                  ...
                  <div className="mt-2 grid grid-cols-2 gap-x-6 gap-y-1 rounded bg-[#faf9f8] p-3 text-[11px]">
                    ...
                    <div><span className="text-[#767065]">Security Deposit:</span> <span className="font-medium text-[#2b2a26]">{yenAmount(isAnnual ? Math.round(rentInfo.amountValue / 6) : rentInfo.amountValue * 2)}</span></div>
