    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto bg-sand-90 p-8">
          <div className="mx-auto max-w-[680px] rounded-lg bg-white p-10 shadow-lg text-sand-830 text-xs leading-relaxed font-sans">
            {/* Header */}
            ...
            <div className="mt-5">
              ...
              <div className="mt-2 grid grid-cols-2 gap-x-6 gap-y-1 rounded bg-page-bg p-3 text-[11px]">
                ...
                <div><span className="text-sand-530">ID Number:</span> <span className="text-sand-830">1-2345-67890-12-3</span></div>
                <div><span className="text-sand-530">Phone:</span> <span className="text-sand-830">012-345-6789</span></div>
                <div><span className="text-sand-530">Line ID:</span> <span className="text-sand-830">@{lease.tenantName.toLowerCase().replace(/\s+/g, '')}</span></div>
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 grid grid-cols-2 gap-x-6 gap-y-1 rounded bg-page-bg p-3 text-[11px]">
                ...
                <div><span className="text-sand-530">Room Type:</span> <span className="text-sand-830">Single / Double Bedroom</span></div>
                <div className="col-span-2"><span className="text-sand-530">Address:</span> <span className="text-sand-830">123 Blossom Lane, Zen District, Tokyo</span></div>
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 grid grid-cols-2 gap-x-6 gap-y-1 rounded bg-page-bg p-3 text-[11px]">
                ...
                <div><span className="text-sand-530">Monthly Rent:</span> <span className="font-bold text-sand-830">{yen(lease.monthlyRent)}</span></div>
                <div><span className="text-sand-530">Security Deposit:</span> <span className="font-medium text-sand-830">{yen(lease.monthlyRent * 2)}</span></div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-2 grid grid-cols-2 gap-x-6 gap-y-1 rounded bg-page-bg p-3 text-[11px]">
                <div><span className="text-sand-530">Electricity:</span> <span className="text-sand-830">¥8.00 per unit</span></div>
                <div><span className="text-sand-530">Water:</span> <span className="text-sand-830">¥18.00 per unit</span></div>
              </div>
            </div>
        ...
        {/* Print Sidebar (Right) */}
        <div className="flex w-72 flex-col justify-between border-l border-sand-740 bg-sand-790 p-6 text-white">
          <div>
            <div className="flex items-center justify-between pb-4 border-b border-sand-680">
              ...
              <button
                ...
                onClick={onClose}
                aria-label="Close"
                className="rounded-md p-1 text-sand-320 hover:bg-white/10 hover:text-white"
              >
                <X size={18} />
              </button>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-4 text-xs">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded bg-sand-860 border border-sand-680 px-3 py-2 text-white outline-none"
                >
          ...
          <div className="flex gap-2 pt-6 border-t border-sand-680">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 rounded-lg border border-sand-680 bg-transparent py-2 text-xs font-medium text-sand-90 hover:bg-white/10"
            >
              Cancel
            </button>
            <button
              type="button"
              onClick={handlePrint}
              className="flex-1 rounded-lg bg-moss-160 py-2 text-xs font-semibold text-moss-740 hover:bg-moss-220"
            >
              Save
            </button>
          </div>
