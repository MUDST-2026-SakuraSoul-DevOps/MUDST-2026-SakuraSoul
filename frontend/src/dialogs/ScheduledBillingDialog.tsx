      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-[#f0ece6] px-6 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="font-heading text-lg font-bold text-[#2b2a26]">Scheduled Bulk Billing</h2>
        ...
        {/* Modal Body */}
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-xs text-[#2b2a26]">
          {/* Status Banner */}
          <div
            className={`flex items-center justify-between rounded-xl p-4 border transition-colors ${
              config.enabled
                ? 'border-[#c8e6c9] bg-[#f1f8e9] text-[#2e7d32]'
          ...
          >
            <div className="flex items-center gap-3">
              <span
                className={`flex size-3 rounded-full ${
                  config.enabled ? 'bg-[#4caf50] animate-pulse' : 'bg-[#9e9e9e]'
                }`}
              />
              <div>
            ...
            <button
              ...
              className={`rounded-lg px-3.5 py-1.5 text-xs font-semibold shadow-sm transition cursor-pointer ${
                config.enabled
                  ? 'bg-white text-[#c62828] border border-[#ef9a9a] hover:bg-[#ffebee]'
                  : 'bg-[#5a3036] text-white hover:bg-[#47262b]'
              }`}
            >
          ...
          {testRunMessage && (
            <div className="flex items-center gap-2 rounded-lg border border-[#b2dfdb] bg-[#e0f2f1] p-3 text-xs text-[#00695c]">
              <Sparkles size={16} />
          ...
          <div className="rounded-xl border border-[#eed9c4]/60 bg-[#faf9f8] p-4 space-y-4">
            <h3 className="font-bold text-xs uppercase tracking-wider text-[#767065] flex items-center gap-1.5">
              <Calendar size={15} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="schedule-day" className="block font-medium text-[#2b2a26] mb-1">
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-[#eed9c4] bg-white px-3 py-2 text-xs text-[#2b2a26] outline-none focus:border-[#5a3036]"
                >
                ...
                <p className="mt-1 text-[10px] text-[#767065]">Recommended: 25th of every month</p>
              </div>

              <div>
                <label htmlFor="schedule-time" className="block font-medium text-[#2b2a26] mb-1">
                  Dispatch Time
                </label>
                <input
                  id="schedule-time"
                  ...
                  className="w-full rounded-lg border border-[#eed9c4] bg-white px-3 py-2 text-xs text-[#2b2a26] outline-none focus:border-[#5a3036]"
                />
                <p className="mt-1 text-[10px] text-[#767065]">Time in Bangkok (UTC+7)</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-[#eed9c4]/60 bg-[#faf9f8] p-4 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <label
                className={`flex items-start gap-3 rounded-lg border p-3 cursor-pointer transition ${
                  config.targetAudience === 'ALL_ACTIVE'
                    ? 'border-[#5a3036] bg-white shadow-xs'
                    : 'border-[#eed9c4] bg-white/60 hover:bg-white'
                }`}
              >
                <input
                  type="radio"
                  ...
                  className="mt-0.5 accent-[#5a3036]"
                />
                <div>
                  <p className="font-bold text-xs text-[#2b2a26]">All Active Tenants</p>
                  <p className="text-[11px] text-[#767065] mt-0.5">
              ...
              >
                ...
                />
                <div>
                  <p className="font-bold text-xs text-[#2b2a26]">Pending Invoices Only</p>
                  <p className="text-[11px] text-[#767065] mt-0.5">
          ...
          <div className="rounded-xl border border-[#eed9c4]/60 bg-[#faf9f8] p-4 space-y-3">
            <h3 className="font-bold text-xs uppercase tracking-wider text-[#767065]">
              3. Delivery Channels &amp; Attachments
            </h3>

            <div className="space-y-2">
              <label className="flex items-center gap-3 rounded-lg bg-white p-2.5 border border-[#eed9c4]/70 cursor-pointer">
                <input
                  type="checkbox"
                ...
                <div className="flex-1">
                  <span className="font-medium text-[#2b2a26]">Email Notification</span>
                  <span className="ml-2 text-[11px] text-[#767065]">(Direct to tenant email address)</span>
                </div>
              </label>
              ...
              <label className="flex items-center gap-3 rounded-lg bg-white p-2.5 border border-[#eed9c4]/70 cursor-pointer">
                ...
                <div className="flex-1">
                  <span className="font-medium text-[#2b2a26]">LINE Official Notification</span>
                  <span className="ml-2 text-[11px] text-[#767065]">(Rich message with payment link)</span>
                </div>
              </label>
              ...
              <label className="flex items-center gap-3 rounded-lg bg-white p-2.5 border border-[#eed9c4]/70 cursor-pointer">
                <input
                  ...
                  className="size-4 rounded accent-[#5a3036]"
                />
                <div className="size-4 flex items-center justify-center text-[#5a3036] font-bold text-[10px]">
                  PDF
                </div>
                <div className="flex-1">
                  <span className="font-medium text-[#2b2a26]">Auto-generate &amp; attach official PDF invoice</span>
                  <span className="ml-2 text-[11px] text-[#767065]">(Includes utility breakdown)</span>
                </div>
              </label>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between border-t border-[#f0ece6] px-6 py-4 bg-white">
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-[#eed9c4] bg-white px-3.5 py-2 text-xs font-medium text-[#5a3036] hover:bg-[#faf9f8] transition cursor-pointer"
          >
            <Sparkles size={14} />
            Test Simulation
          </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="flex items-center gap-2 rounded-lg bg-[#5a3036] px-5 py-2 text-xs font-semibold text-white shadow-sm hover:bg-[#47262b] transition cursor-pointer"
            >
              {isSaved ? (
                <>
                  <Check size={14} /> Saved!
