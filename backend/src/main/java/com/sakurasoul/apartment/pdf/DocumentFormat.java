 ...
 *
 * <h2>ทำไมชื่อคลาสไม่ใช่ ThaiFormat แล้ว ทั้งที่เงินกลับมาเป็นบาท</h2>
 * เดิมคลาสนี้พิมพ์เงินเป็นบาทและวันที่เป็นปี พ.ศ. ชื่อจึงตรงกับงานที่ทำ รอบ SSK-105
 * ทั้งระบบเปลี่ยนเป็นอังกฤษและเงินเป็นเยน จึงเปลี่ยนชื่อเป็น DocumentFormat
 * <p>
 * รอบ SSK-126 อาจารย์ให้เปลี่ยนสกุลเงินกลับเป็นบาท แต่ **วันที่ยังเป็นอังกฤษและ ค.ศ. อยู่**
 * คลาสนี้จึงไม่ได้กลับไปเป็น "ไทยทั้งก้อน" เหมือนเดิม ชื่อ DocumentFormat ยังตรงกับงานที่ทำที่สุด
 * ถ้าเปลี่ยนกลับเป็น ThaiFormat จะหลอกคนอ่านว่าวันที่เป็น พ.ศ. ด้วย
 * <p>
...
public final class DocumentFormat {
    ...
    /**
     * "฿3,500.00" มีตัวคั่นหลักพันและทศนิยมสองตำแหน่งเสมอ
     * <p>
     * บาทมีสตางค์ ใบเสร็จกับสัญญาจึงต้องเขียนทศนิยมให้ครบสองตำแหน่งทุกครั้ง แม้ยอดจะลงตัว
     * เพราะเป็นเอกสารที่ใช้อ้างอิงทางกฎหมาย การพิมพ์ ฿3,500 เฉย ๆ เปิดช่องให้ตีความว่าปัดเศษมาแล้ว
     * <p>
     * ตรงข้ามกับรอบ SSK-105 ที่เป็นเยนแล้วตัดทศนิยมทิ้ง เพราะเยนไม่มีหน่วยย่อย
     * <p>
     * กฎเดียวกับ bahtAmount ใน frontend/src/format.ts แก้ที่นี่ต้องไปแก้ที่นั่นด้วย
     */
    public static String money(BigDecimal value) {
        return "฿" + grouped(value.setScale(2, RoundingMode.HALF_UP), "#,##0.00");
    }

    /**
     * "120" หรือ "120.5" ตัวเลขล้วนของหน่วยมิเตอร์ ไม่ใช่จำนวนเงิน จึงไม่มีสัญลักษณ์สกุลเงิน
     * <p>
