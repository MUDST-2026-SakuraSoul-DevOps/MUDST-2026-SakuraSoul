...
7. **หน้า Maintenance** (SSK-18 ถึง SSK-21)
   **ไม่ต้องรออะไรแล้ว ลงมือได้เลย** `V8__maintenance.sql` กับ endpoint ฝั่ง backend ขึ้นครบแล้ว
   ...
   แท็บ Supplies & Inventory ต่อแล้วใน SSK-23 แท็บที่ยังเหลือคือ Reminders
...
สามคำสั่งนี้คือสิ่งเดียวกับที่ `build-lint-test.yml` รันบน GitHub ถ้าผ่านที่เครื่องแล้วยังแดง
